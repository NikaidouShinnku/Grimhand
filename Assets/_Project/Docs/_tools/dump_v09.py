#!/usr/bin/env python3
"""Dump every sheet of v0.9 overview Excel to UTF-8 text files for review."""
...
SRC = Path(r"c:\Users\Kelthuzad\Desktop\Grimhand实际内容总览表v0.9.xlsx")
OUT_DIR = Path(__file__).resolve().parent / "_v09_dump"
