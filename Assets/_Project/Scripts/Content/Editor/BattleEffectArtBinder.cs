...
namespace Grimhand.Content.Editor
{
    public static class BattleEffectArtBinder
    {
        ...
        public static bool BindBattleEffectsSilent()
        {
            ...
            catalog.SnakeQueenDamage = LoadNamedSprite(
                EffectRoot + "snakequeen_damage_effect.png",
                "snakequeen_damage_effect_0");
            catalog.LichQueenDamage = LoadNamedSprite(
                EffectRoot + "lichqueen_damage_effect.png",
                "lichqueen_damage_effect_0");
            ...
            catalog.WardenDamage = LoadNamedSprite(
                EffectRoot + "warden_damage_effect.png",
                "warden_damage_effect_0");
            catalog.DarkKnightDamage = LoadNamedSprite(
                EffectRoot + "darkknight_damage_effect.png",
                "darkknight_damage_effect_0");
            catalog.CorruptedOceanGoddessDamage = LoadNamedSprite(
                EffectRoot + "corrupted_oceangoddess_damage_effect.png",
                "corrupted_oceangoddess_damage_effect_0");
