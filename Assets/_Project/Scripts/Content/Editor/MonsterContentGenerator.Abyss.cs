    ...
    public static partial class MonsterContentGenerator
    {
        ...
        static AbyssCards CreateAbyssCards() =>
            new()
            {
                ...
                FesterClaw = SaveCard("m_fester_claw", "溃烂钳击", "char_corrupted_crab", 3, CardType.Attack,
                    Kw("respond_status", "respond_defense"), CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 9,
                        condition: ReactionConditionType.LastActionDefenseOnTarget),
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 9,
                        condition: ReactionConditionType.LastActionStatusOnTarget),
