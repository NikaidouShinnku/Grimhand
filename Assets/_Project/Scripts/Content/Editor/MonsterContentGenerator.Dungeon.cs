    ...
    public static partial class MonsterContentGenerator
    {
        ...
        static DungeonCards CreateDungeonCards() =>
            new()
            {
                ...
                RatBurrow = SaveCard("m_rat_burrow", "钻地逃遁", "char_rat", 2, CardType.Defense, null,
                    CardRarity.Rare,
                ...
                GargoyleClaw = SaveCard("m_gargoyle_claw", "利爪斩击", "char_gargoyle", 1, CardType.Attack, null,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 10, scaleAttack: true)),
                ...
                GargoyleSunder = SaveCard("m_gargoyle_sunder", "破甲冲锋", "char_gargoyle", 2, CardType.Attack, null,
                    CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 10, scaleAttack: true,
