...
namespace Grimhand.Content.Editor
{
    public static partial class MonsterContentGenerator
    {
        ...
        static DungeonCards CreateDungeonCards() =>
            new()
            {
                RatPunch = SaveCard("m_rat_punch", "鼠人拳击", "char_rat", 1, CardType.Attack, null,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 6, scaleAttack: true)),
                RatTrash = SaveCard("m_rat_trash", "投掷垃圾", "char_rat", 1, CardType.Attack, null,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 5, scaleAttack: true,
                        reach: TargetReach.MiddleAndBack)),
                RatAmbush = SaveCard("m_rat_ambush", "偷袭", "char_rat", 2, CardType.Attack, null, CardRarity.SuperRare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 12,
                        useAlternateIfTargetHasAnyStatus: true, alternateValue: 24)),
                RatMorale = SaveCard("m_rat_morale", "提振士气", "char_rat", 2, CardType.Status, null, CardRarity.Rare,
                    Action(EffectActionType.ApplyStatus, EffectTarget.AllAllies, 0,
                        statusId: StatusCatalog.SpeedUp, stacks: 1, duration: 2),
                    Action(EffectActionType.ApplyStatus, EffectTarget.AllAllies, 0,
                        statusId: StatusCatalog.AttackUpPercent, stacks: 20, duration: 2)),
                RatBurrow = SaveCard("m_rat_burrow", "钻地逃遁", "char_rat", 2, CardType.Defense, Kw("parry"),
                    CardRarity.Rare,
                ...
                ChainWhip = SaveCard("m_chain_whip", "锁链鞭打", "char_chain_wraith", 1, CardType.Attack, null,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 7, scaleAttack: true)),
                ChainGrudge = SaveCard("m_chain_grudge", "怨气缠绕", "char_chain_wraith", 1, CardType.Status, null,
                    Action(EffectActionType.ApplyStatus, EffectTarget.Self, 0,
                        statusId: StatusCatalog.Slow, stacks: 1, duration: 2),
                    Action(EffectActionType.ApplyStatus, EffectTarget.RandomEnemy, 0,
                        statusId: StatusCatalog.Slow, stacks: 1, duration: 2)),
                ChainThrow = SaveCard("m_chain_throw", "怨链投掷", "char_chain_wraith", 2, CardType.Attack, null,
                    CardRarity.Rare,
                ...
                ChainGuard = SaveCard("m_chain_guard", "锁链护体", "char_chain_wraith", 1, CardType.Defense, null,
                ...
                GargoyleClaw = SaveCard("m_gargoyle_claw", "利爪劈击", "char_gargoyle", 1, CardType.Attack, null,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 11)),
                GargoylePetrify = SaveCard("m_gargoyle_petrify", "石化形态", "char_gargoyle", 2, CardType.Defense, null,
                    CardRarity.Rare,
                    Action(EffectActionType.GainBlock, EffectTarget.Self, 11),
                    Action(EffectActionType.ApplyStatus, EffectTarget.Self, 0,
                        statusId: StatusCatalog.Slow, stacks: 2, duration: 1)),
                GargoyleSunder = SaveCard("m_gargoyle_sunder", "破甲俯冲", "char_gargoyle", 2, CardType.Attack, null,
                    CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 10,
                        reach: TargetReach.Any)),
                GargoyleEmpower = SaveCard("m_gargoyle_empower", "活体强化", "char_gargoyle", 3, CardType.Status, null,
                    CardRarity.Epic,
                    Action(EffectActionType.ApplyStatus, EffectTarget.Self, 0,
                        statusId: StatusCatalog.AttackUpPercent, stacks: 100, duration: 1),
                    Action(EffectActionType.ReducePlayerEnergyRegenNextTurn, EffectTarget.Self, 2)),
                ...
                GargoyleSleepStone = SaveCard("m_gargoyle_sleep_stone", "沉睡之石", "char_gargoyle", 2, CardType.Status,
                    null, CardRarity.Epic),
                SpiderFang = SaveCard("m_spider_fang", "毒牙刺击", "char_spider_lady", 1, CardType.Attack, null,
                    CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 9,
                        reach: TargetReach.FrontAndMiddle),
                    Action(EffectActionType.ApplyStatus, EffectTarget.DefaultEnemy, 0,
                        statusId: StatusCatalog.Poison, stacks: 5, duration: -1, chancePercent: 30)),
                ...
                SpiderTrap = SaveCard("m_spider_trap", "蛛网陷阱", "char_spider_lady", 2, CardType.Status, null,
                    CardRarity.Rare,
                    Action(EffectActionType.IncreaseRandomPlayerHandCosts, EffectTarget.DefaultEnemy, 2, stacks: 1)),
                SpiderSpray = SaveCard("m_spider_spray", "剧毒喷射", "char_spider_lady", 3, CardType.Attack, Kw("aoe"),
                    CardRarity.Epic,
                    Action(EffectActionType.DealDamage, EffectTarget.AllEnemies, 7,
                        reach: TargetReach.Any),
                    Action(EffectActionType.ApplyStatus, EffectTarget.AllEnemies, 0,
                        statusId: StatusCatalog.Poison, stacks: 7, duration: -1, reach: TargetReach.Any)),
                SpiderWrap = SaveCard("m_spider_wrap", "蛛网包裹", "char_spider_lady", 2, CardType.Defense, Kw("parry"),
                    CardRarity.Rare,
                    Action(EffectActionType.GainBlockFromLastDamagePercent, EffectTarget.Self, 50,
                        condition: ReactionConditionType.LastActionAttackOnSelf),
                    Action(EffectActionType.LockAttackCards, EffectTarget.LastActionActor, 2,
                        condition: ReactionConditionType.LastActionAttackOnSelf)),
                SpiderFatalBind = SaveCard("m_spider_fatal_bind", "致命缠杀", "char_spider_lady", 4, CardType.Attack,
                    Kw("exhaust"), CardRarity.Epic,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 18,
                        reach: TargetReach.MiddleAndBack)),
                GolemFist = SaveCard("m_golem_fist", "石拳", "char_stone_golem", 2, CardType.Attack, null,
                    CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 10,
                        reach: TargetReach.FrontAndMiddle,
                        selfBlockAboveThreshold: 20, alternateValueIfSelfBlockAbove: 20)),
                GolemWall = SaveCard("m_golem_wall", "石之壁垒", "char_stone_golem", 2, CardType.Defense, null,
                    CardRarity.Rare,
                ...
                GolemUnmovable = SaveCard("m_golem_unmovable", "不动如山", "char_stone_golem", 3, CardType.Defense, Kw("parry"),
                    ...
                    Action(EffectActionType.GainBlockFromLastDamagePercent, EffectTarget.Self, 90,
                        condition: ReactionConditionType.LastActionAttackOnSelf),
                    Action(EffectActionType.ApplyStatus, EffectTarget.Self, 0,
                        statusId: StatusCatalog.DamageReduction, stacks: 20, duration: 3)),
                GolemQuakeSlam = SaveCard("m_golem_quake_slam", "山崩地裂", "char_stone_golem", 3, CardType.Attack, null,
                    CardRarity.Epic,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 17,
                        reach: TargetReach.FrontAndMiddle,
                        alternateValue: 40, useAlternateIfActorNotHitThisTurn: true)),
                GolemCrackFist = SaveCard("m_golem_crack_fist", "崩裂拳", "char_stone_golem", 3, CardType.Attack, null,
                    CardRarity.Rare,
                    Action(EffectActionType.DealDamage, EffectTarget.DefaultEnemy, 6, scaleAttack: true),
